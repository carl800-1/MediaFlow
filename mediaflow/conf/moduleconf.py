...
class ModuleConf(object):
    ...
    RMT_MODES_LITE: Dict[str, RmtMode] = {
        "copy": RmtMode.COPY,
        "link": RmtMode.LINK,
        "softlink": RmtMode.SOFTLINK,
        "move": RmtMode.MOVE
    ...
    REMOTE_RMT_MODES: List[RmtMode] = [RmtMode.RCLONE, RmtMode.RCLONECOPY, RmtMode.MINIO, RmtMode.MINIOCOPY]
    ...
    @staticmethod
    def get_enum_name(enum: Any, value: Any) -> Optional[str]:
        """
        根据Enum的value查询name
        """
        for e in enum:
    ...
    @staticmethod
    def get_enum_item(enum: Any, value: Any) -> Optional[Any]:
        """
        根据Enum的value查询item
        """
        for e in enum:
    ...
    @staticmethod
    def get_dictenum_key(dictenum: Dict[str, Any], value: Any) -> Optional[str]:
        """
