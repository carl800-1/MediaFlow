...
class MediaDb:
    ...
    def insert(self, server_type: str, iteminfo: Dict[str, Any], seasoninfo: Any) -> bool:
    ...
    def empty(self, server_type: Optional[str] = None, library: Optional[str] = None) -> bool:
        try:
    ...
    def statistics(self, server_type: str, total_count: int, movie_count: int, tv_count: int) -> bool:
        if not server_type:
            return False
        try:
    ...
    def query(self, server_type: str, title: str, year: Optional[str], tmdbid: Optional[int]) -> Any:
    ...
    def get_statistics(self, server_type: str) -> Optional[Any]:
        if not server_type:
            return None
